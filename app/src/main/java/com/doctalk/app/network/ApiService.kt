...
import com.doctalk.app.data.model.DocumentSearchResponse
...
interface ApiService {
     ...
     */
    @POST("chat/query")
    suspend fun sendChatQuery(@Body request: ChatRequest): Response<ChatResponse>
    ...
    suspend fun getDocumentStatus(@Path("documentId") documentId: String): Response<com.doctalk.app.data.model.DocumentStatusResponse>
